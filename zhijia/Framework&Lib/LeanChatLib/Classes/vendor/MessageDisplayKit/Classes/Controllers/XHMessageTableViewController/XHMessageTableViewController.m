...
//    XHMessageTableView *messageTableView = [[XHMessageTableView alloc] initWithFrame:CGRectMake(0, 100, self.view.frame.size.width, 500) style:UITableViewStylePlain];
