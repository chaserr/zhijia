...
- (void)createToolbar
{
    ...
    if (_isShowSelectBtn) {
        ...
        _selectImageBtn.frame = CGRectMake(self.view.frame.size.width-32 -20, 30, 32, 32);
        _selectImageBtn.autoresizingMask = UIViewAutoresizingFlexibleHeight;
        [_selectImageBtn setImage:[UIImage imageNamed:@"common_icon_checked"] forState:UIControlStateNormal];
...
-(void)selectImage:(UIButton *)sender
{
    if (_is_selectImageBtnBool == YES) {
        ...
        [sender setImage:[UIImage imageNamed:@"common_icon_unchecked"] forState:UIControlStateNormal];
    ...
    }else
    {
        ...
        _is_selectImageBtnBool = YES;
        [sender setImage:[UIImage imageNamed:@"common_icon_checked"] forState:UIControlStateNormal];
    }
...
- (void)scrollViewDidEndDecelerating:(UIScrollView *)scrollView
{
    ...
    if ([self.selectImageSet containsObject:@(_currentPhotoIndex+1)]) {
        _is_selectImageBtnBool = NO;
        [_selectImageBtn setImage:[UIImage imageNamed:@"radio_btn_off"] forState:UIControlStateNormal];
    }else{
        [_selectImageBtn setImage:[UIImage imageNamed:@"radio_btn_on"] forState:UIControlStateNormal];
        _is_selectImageBtnBool = YES;
    }
