...
@interface QBAlbumsViewController () <PHPhotoLibraryChangeObserver,UITableViewDelegate,UITableViewDataSource>
...
//        self.fetchResults = [[NSMutableArray alloc] init]; ;
//    }
//    if(smartAlbums != nil)
//    {
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    self.navigationTitleLabel.text = @"相册";
    // Configure navigation item
//    NSLocalizedStringFromTableInBundle(@"albums.title", @"QBImagePicker", self.imagePickerController.assetBundle, nil);
