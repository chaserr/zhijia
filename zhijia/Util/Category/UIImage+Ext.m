...
+ (UIImage*)blurImage:(UIImage *)inputImage withBlurLevel:(CGFloat)blurLevel
{
    ...
    //    //    CIImage *inputImage = [[CIImage alloc] initWithContentsOfURL:[NSURL URLWithString:imageurl]];
    ...
    //    UIImage *images = [UIImage imageWithCGImage:cgImage];
    //    CGImageRelease(cgImage);
    
    //    return images;
    if ((blurLevel < 0.0f) || (blurLevel > 1.0f))
    {
        blurLevel = 0.5f;
    }
    ...
    CGImageRef img = inputImage.CGImage;
