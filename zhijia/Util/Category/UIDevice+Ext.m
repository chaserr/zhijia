...
+ (NSString *)getCurrentDeviceName
{
    ...
    if ([platform isEqualToString:@"iPhone4,1"] ||
        [platform isEqualToString:@"iPhone4,2"] ||
        [platform isEqualToString:@"iPhone4,3"])    return @"iPhone 4S";
...
+ (BOOL)isIphone6s
{
    return [[[UIDevice getCurrentDeviceName] lowercaseString] rangeOfString:[@"iPhone 6s" lowercaseString]].length > 0;
}

+ (BOOL)isIphone6sPlus
{
    return [[[UIDevice getCurrentDeviceName] lowercaseString] rangeOfString:[@"iPhone 6s Plus" lowercaseString]].length > 0;
}
