...
- (instancetype)initWithStyle:(InputBarStyle)style {
    ...
    self = [super initWithFrame:CGRectMake(-0.5, ScreenHeight, ScreenWidth+1, height)];
...
//    CGRect beginKeyboardRect = [[info objectForKey:UIKeyboardFrameBeginUserInfoKey] CGRectValue];
    ...
    [UIView animateWithDuration:duration
                     ...
                     animations:^{
                         ...
                         newInputViewFrame.origin.y = [UIScreen mainScreen].bounds.size.height-CGRectGetHeight(self.frame)-endKeyboardRect.size.height;
