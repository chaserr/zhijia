...
+ (id)alertWithTitle:(NSString *)title
   ...
   cancelButtonBlock:(STAlertViewBlock)cancelButtonBlock
    ...
    return [[STAlertView alloc] initWithTitle:title message:message cancelButtonTitle:cancelButtonTitle otherButtonTitles:otherButtonTitles cancelButtonBlock:cancelButtonBlock otherButtonBlock:otherButtonBlock];
}
