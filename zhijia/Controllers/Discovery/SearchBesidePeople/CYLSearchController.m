...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section {
    if (self.isShowQuestions) {
        _superViewController.navigationController.view.backgroundColor = BACKGROUND_COLOR;
        return self.questionDataSource.count;
    } else {
        _superViewController.navigationController.view.backgroundColor = [UIColor clearColor];
